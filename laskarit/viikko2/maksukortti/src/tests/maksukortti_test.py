...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_pystyy_ostamaan_edullisen_lounaan_kun_kortilla_rahaa_vain_sen_hinta(self):
        kortti = Maksukortti(2.5)
        kortti.syo_edullisesti()
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.0 euroa") 

    def test_pystyy_ostamaan_maukkaan_lounaan_kun_kortilla_rahaa_vain_sen_hinta(self):
